...
class ImageEditorApp:
    def __init__(self, root):
        ...
        self.annotation_option_label = tk.Label(button_frame, text="Input weight/volume/portion/cho?")
        ...
        self.grams_label = tk.Label(button_frame, text="Weight/Volume/Portion/CHO:")
